...
void StartCommRxTask(void *argument) {
	...
	rx_message.destination.destination_latitude = 36.0f;
	rx_message.destination.destination_longitude = 129.0f;
	rx_message.destination.destination_altitude = 1200.0f;
	rx_message.destination_valid = true;
